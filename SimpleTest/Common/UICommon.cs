...
namespace SimpleTest.Common
{
    public static class UICommon
    {
        ...
        public static void ShowDataNotFoundMsg()
        {
            ShowSplashPanelMessage("Không tìm thấy dữ liệu.");
        }

        public static void ShowMsgUpdateSuccess()
        {
            ShowSplashPanelMessage("Cập nhật dữ liệu thành công.");
        }

        public static void ShowMsgSplashPanelUnComplete()
        {
            ShowSplashPanelMessage("Cập nhập dữ liệu thất bại.");
        }
